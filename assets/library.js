(function (window, document) {
  ...
  function mountLayout(active, content) {
    ...
    root.innerHTML = header(active) + content + footer();
  ...
  function renderItem() {
    ...
    const preview = available
      ...
      : `<div class="preview-panel"><strong>Not released</strong><p>This page describes the planned scope only. NORTH has not connected a completed asset, delivery system, support path, refund policy, or merchant-of-record checkout for this item.</p></div>`;
